        ...
        try {
            ...
            if ($ExisteUsuario) {
                ...
                if (password_verify($constrasena, $passDB)) {
                    ...
                    $sqlpermisos = "SELECT permiso_clave as permiso from asig_permisos inner join permiso on asignacion_permiso_id = permiso_id where asignacion_usuario_id = $idUsuario";
